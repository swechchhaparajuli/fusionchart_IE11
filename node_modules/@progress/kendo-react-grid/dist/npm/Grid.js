...
var GridSelection_1 = require("./selection/GridSelection");
/**
    ...
    function Grid(props) {
        ...
        _this.onKeyDown = function (event) {
            ...
            if (_this.props.onKeyDown) {
                var _a = GridSelection_1.getSelectionOptions(_this.props.selectable), mode = _a.mode, cell = _a.cell;
        ...
        _this.selectionRelease = function (event) {
            if (_this.props.onSelectionChange) {
                _this.props.onSelectionChange.call(undefined, __assign({ syntheticEvent: undefined, target: _this, selectedField: _this.props.selectedField, componentId: _this._gridId, dataItems: _this.getLeafDataItems(), dataItem: null }, event));
            }
        };
    ...
    Grid.prototype.render = function () {
        ...
        var dataRow = function (item, rowId, rowDataIndex) {
            ...
            if (_this.props.selectedField) {
                selectedValue = index_1.getNestedValue(_this.props.selectedField, item.dataItem);
            }
            return {
        ...
        if (this._data.length) {
            ...
            this._data.forEach(function (item, rowIndex) {
                ...
                if (_this.props.detail && item.rowType === 'data' && item.expanded) {
                    ...
                    detailRowCount_1++;
                    body.push((React.createElement("tr", { key: rowDetailId, className: isAlt ? 'k-detail-row k-alt' : 'k-detail-row', style: { visibility: hidden(rowIndex) ? 'hidden' : '' }, "aria-rowindex": absoluteIndex + rowIndexStart + detailRowCount_1 },
                        _this.props.group && _this.props.group.map(function (group, idx) {
                            return (React.createElement(GridGroupCell_1.GridGroupCell, { id: '', dataIndex: item.dataIndex, field: group.field, dataItem: item.dataItem, key: idx, style: {}, ariaColumnIndex: 1, isSelected: false }));
                        }),
        ...
        if (this.props.scrollable === 'none') {
            return (React.createElement(kendo_react_data_tools_1.TableKeyboardNavigationContext.Provider, { value: this.contextStateRef.current },
                React.createElement("div", __assign({ style: this.props.style, className: kendo_react_common_1.classNames('k-widget k-grid', this.props.className), "aria-colcount": columnsWithColGroup.length, "aria-rowcount": total, ref: function (el) { _this.element = el; }, onKeyDown: this.onKeyDown, onFocus: this.onFocus }, kendo_react_data_tools_1.tableKeyboardNavigationScopeAttributes),
                    toolbar,
                    groupingPanel,
                    React.createElement(GridSelection_1.GridSelection, { selectable: this.props.selectable, onRelease: this.selectionRelease },
                        React.createElement("table", { style: { userSelect: tableUserSelect }, ref: function (table) {
                ...
                React.createElement("div", { className: "k-grid-container", role: "presentation" },
                    React.createElement("div", { ref: function (container) {
                        ...
                        React.createElement("div", { style: { 'position': 'relative' }, role: "presentation" },
                            React.createElement(GridSelection_1.GridSelection, { selectable: this.props.selectable, onRelease: this.selectionRelease },
                                React.createElement("table", { className: 'k-grid-table', ref: function (table) { return _this.vs.table = table; }, role: "presentation", style: { userSelect: tableUserSelect } },
                                    colGroups,

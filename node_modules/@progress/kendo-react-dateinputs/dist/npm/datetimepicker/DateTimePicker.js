...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    DateTimePicker.prototype.render = function () {
        ...
        var dateTimePicker = (React.createElement(kendo_react_common_1.AsyncFocusBlur, { onFocus: this.handleFocus, onBlur: this.handleBlur, onSyncFocus: this.props.onFocus, onSyncBlur: this.props.onBlur }, function (_a) {
            ...
            return (React.createElement("div", { ref: function (div) {
                ...
                React.createElement("div", { ref: function (span) { _this._wrapper = span; }, className: wrapperClassNames },
                    React.createElement(_this.dateInputComp, __assign({ _ref: _this.setDateInputRef }, dataInputProps)),
        ...
        return this.props.label
            ? (React.createElement(usePickerFloatingLabel_1.PickerFloatingLabel, { dateInput: this.dateInput, label: this.props.label, editorId: id, editorValid: isValid, editorDisabled: this.props.disabled, children: dateTimePicker, style: { width: this.props.width } }))
            : dateTimePicker;
    };

...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.render = function () {
        ...
        return (React.createElement("tbody", { role: "rowgroup", className: "k-calendar-tbody" },
            ...
            (this.isMonthView && this.isHorizontal) && (React.createElement("tr", { role: "row", className: "k-calendar-tr" }, weekNames.map(function (name, idx) { return (React.createElement("th", { key: idx, className: "k-calendar-th" }, name)); }))),
